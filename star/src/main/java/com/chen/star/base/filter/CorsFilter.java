package com.chen.star.base.filter;

import com.chen.star.base.dto.GlobalProperies;
...
public class CorsFilter implements Filter
{
    ...
    private static final String HEADERS = "User-Agent,Cache-Control,Content-type,Date,Server,withCredentials,Authorization,"
            + "appversion";
