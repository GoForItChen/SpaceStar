...
public class GeneratorCode {
    ...
    /** 模块名 */
    private static String moduleName = "dubbotest";
    ...
    private static String url = "jdbc:mysql://rm-bp1t12n9s6964jm1jgo.mysql.rds.aliyuncs.com:3306/stardb?stringtype=unspecified";
    private static String username = "chenwei";
    private static String password = "Chenstar123";
    private static String driverName = "com.mysql.cj.jdbc.Driver";
    private static String schemaName = "public";

    private static String parent = "com.chen.star";
    ...
    private static StrategyConfig strategyConfig() {
        ...
        strategy.setSuperServiceClass("com.chen.star.extension.service.IService");
        strategy.setSuperServiceImplClass("com.chen.star.extension.service.impl.ServiceImpl");
...
//        templateConfig.setController("/generator/templates/controller.java");
    ...
    private static PackageConfig packageConfig() {
        ...
        pc.setXml("mapper." + moduleName + ".mapper");
